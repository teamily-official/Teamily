...
export const ProcessSection = ({ content, contentClassName }) => {
  ...
  // Smooth step calculation so image stays until next step
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    const segment = 1 / cardLength; // each step takes equal scroll space
  ...
  return (
    <div>
      <h2 className="text-4xl text-center sm:text-5xl font-bold text-gray-900 my-14 transition-transform duration-300 hover:scale-105">
        Our 6-Step Workflow
      </h2>
      ...
      <motion.div
        ...
        className="relative flex h-[40rem] justify-evenly space-x-10 overflow-y-auto rounded p-12  "
        ref={ref}
      >
        {/* Text Section */}
